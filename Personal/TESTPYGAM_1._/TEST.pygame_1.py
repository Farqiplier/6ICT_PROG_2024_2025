...
schaal1= 3
achter = pygame.image.load(r"TESTPYGAM_1._\achtergrond\achtergrond.jpg") 
...
schaal4 = 0.5 
explosie = pygame.image.load(r'TESTPYGAM_1._\explosie2.webp')
...
while running:
   ...
   # Botst vliegtuig met doodlebob? Stop dan spel.
   if jet.colliderect(doodlebob) and hp == 5:
      hp = hp-1
     
   
   if jet.colliderect(doodlebob) and hp == 4:
      HPbar_FULL = HPbar_1e_hit
      hp = hp-1
      
      print('eerste hit ')

   if jet.colliderect(doodlebob) and hp == 3:
      HPbar_FULL = HPbar_2e_hit
      hp = hp-1
      
      print('tweede hit ')

   if jet.colliderect(doodlebob) and hp == 2:
      HPbar_FULL = HPbar_3e_hit
      hp = hp-1
      
      print('derde hit ')

   if jet.colliderect(doodlebob) and hp == 1:
      HPbar_FULL = HPbar_4e_hit
      hp = hp-1
      
      print('vierde hit ')

   if jet.colliderect(doodlebob) and hp == 0:
      jet_foto = explosie
