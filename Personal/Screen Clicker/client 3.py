...
while True:
    ...
    if command.lower() == "exit":
        ...
        break
    elif command.lower() == "start cam1":
        # Start recording video in a separate thread
        recordingcam1_thread = threading.Thread(target=record_video1)
    elif command.lower() == "start cam2":
        # Start recording video in a separate thread
        recordingcam2_thread = threading.Thread(target=record_video2)
        recordingcam2_thread.start()
